...
std::vector<wall_type> LoadWalls()
{
	...
	std::vector<wall_type>{
		...
		{PIXPACK(0x3C3C3C), PIXPACK(0x000000), 1, Renderer::WallIcon, String("AIRONLY WALL"),    "DEFAULT_WL_AIR",    String(ByteString("压力墙,允许压力通过,阻挡一切物质").FromUtf8()) },
		...
		{PIXPACK(0x242424), PIXPACK(0x101010), 0, Renderer::WallIcon, String("EHOLE"),           "DEFAULT_WL_EHOLE",  String(ByteString("电锁体,吸收物质,通电时释放").FromUtf8()) },
		{PIXPACK(0x579777), PIXPACK(0x000000), 1, Renderer::WallIcon, String("GAS WALL"),        "DEFAULT_WL_GAS",    String(ByteString("气体墙,允许气体通过").FromUtf8()) },
		{PIXPACK(0xFFEE00), PIXPACK(0xAA9900), 4, Renderer::WallIcon, String("GRAVITY WALL"),    "DEFAULT_WL_GRVTY",  String(ByteString("引力墙,范围内的万有引力(注:默认的普通引力除外,可以按W切换)将失效").FromUtf8()) },
